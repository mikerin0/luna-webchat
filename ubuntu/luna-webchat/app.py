...
MEMORY_DB_PATH = os.getenv("LUNA_MEMORY_DB", str(Path(__file__).with_name("luna_memory.db")))
...
LUNA_PI_PASSWORD = os.getenv("LUNA_PI_PASSWORD", "ROTATED-SECRET-REDACTED").strip()
